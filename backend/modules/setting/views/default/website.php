    ...
    <div class="col-lg-6 col-sm-6">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12"><?= $websiteform->field($website, 'seo_description')->textarea() ?></div>

                </div>
                <div class="row">
                    <div class="col-lg-12 col-sm-12"><?= $websiteform->field($website, 'website_statics_script')->textarea() ?></div>
                </div>
                <div class="row">
