...
/*end*Maintain*/
	...
	/*start*MovieInfo*/
	'Not Remainding' =>'',//'remain'=0, 提醒.0=未提醒,1=已经提醒.
	'Remained' =>'',//'remain'=1, 提醒.0=未提醒,1=已经提醒.
	'All' =>'',//'auth'=0, 权限.0=所有人,1=登录,2=会员,3=管理员
	'Login' =>'',//'auth'=1, 权限.0=所有人,1=登录,2=会员,3=管理员
	'Member' =>'',//'auth'=2, 权限.0=所有人,1=登录,2=会员,3=管理员
	'Adminor' =>'',//'auth'=3, 权限.0=所有人,1=登录,2=会员,3=管理员
	'Normal' =>'',//'level'=0, 级别.0=和谐,1=18以上
	'Over 18s' =>'',//'level'=1, 级别.0=和谐,1=18以上
	'Unpublished' =>'',//'publish'=0, 发布.0草稿,1发布
	'Published' =>'',//'publish'=1, 发布.0草稿,1发布
	'Waiting' =>'',//'status'=0, 状态值.0待审核,1审核通过,2正在审核,3审核不通过.
	'Passed' =>'',//'status'=1, 状态值.0待审核,1审核通过,2正在审核,3审核不通过.
	'Checking' =>'',//'status'=2, 状态值.0待审核,1审核通过,2正在审核,3审核不通过.
	'Failed' =>'',//'status'=3, 状态值.0待审核,1审核通过,2正在审核,3审核不通过.
	'Movie' =>'',//'type'=0, 类型.0=电影,1=纪录片,2=动漫,3=电视剧.
	'Documentary' =>'',//'type'=1, 类型.0=电影,1=纪录片,2=动漫,3=电视剧.
	'Cartoon' =>'',//'type'=2, 类型.0=电影,1=纪录片,2=动漫,3=电视剧.
	'TV' =>'',//'type'=3, 类型.0=电影,1=纪录片,2=动漫,3=电视剧.
/*end*MovieInfo*/
