...
<div class="article-cate-index">
    ...
    <p>
        <?= Html::a('<i class="fa fa-plus-square"></i> '.Yii::t('app', 'Create Article Cate'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
               ...
               'attribute'=>'status',
               'filter'=>\common\components\behaviors\StatusCode::tranStatusCode(common\models\data\ArticleCate::$status_code,'app'),
